		...
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form:form method="POST"
					action="${contextPath}/registrationEnrollee"
					...
					<div class="wrap-input100 validate-input">
						<span class="label-input100">Surname</span> <input
							...
							placeholder="Surname..."> <span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input">
						<span class="label-input100">Login</span> <input class="input100"
							type="text" name="login" placeholder="Login..."> <span
							class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input">
						<span class="label-input100">Math score</span> <input
							class="input100" type="text" name="mathScore" placeholder="180">
					...
					<div class="wrap-input100 validate-input">
						<span class="label-input100">English score</span> <input
							...
							placeholder="180"> <span class="focus-input100"></span>
					</div>
